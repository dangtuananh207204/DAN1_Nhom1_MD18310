...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(Hang);
        String HoaDon="CREATE TABLE HOADON(maHoaDon INTEGER PRIMARY KEY AUTOINCREMENT,maHang INTEGER REFERENCES LOAIHANG(maHang), soLuongMua INTEGER ,giaHoaDon INTEGER,Ngay TEXT, traHang INTEGER )";
        db.execSQL(HoaDon);
        ...
        db.execSQL(eHang);
        String eHoaDon="INSERT INTO HOADON VALUES(1,1,2,70000000,'2023-11-22',1),(2,2,3,36000000,'2023-11-23',0)";
        db.execSQL(eHoaDon);
